...
namespace DataAccess.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Age", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "LastName", "Location", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "Password", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Picture", "RefreshToken", "RefreshTokenExpiryTime", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { 1, 0, 23, "8c462819-39ad-49bb-87ae-1a36767263f0", null, false, "Kiss", "Janos", null, false, null, null, "KISSJANOS", "asd", "asd", null, false, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, false, "kissjanos" },
                    { 2, 0, 32, "bd8cb9a7-3719-4011-86cd-eed51f5ac481", null, false, "Nagy", "Feró", null, false, null, null, "NAGYFERO", "asd", "asd", null, false, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, false, "nagyfero" },
                    { 3, 0, 43, "f8cc3f23-6bbc-4969-823c-d48dbd8dbf14", null, false, "Vicc", "Elek", null, false, null, null, "VICCELEK", "asd", "asd", null, false, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, false, "viccelek" },
                    { 4, 0, 17, "8977a56f-b208-48ec-9bac-d364753e0de8", null, false, "Maku", "Látlan", null, false, null, null, "MAKULATLAN", "asd", "asd", null, false, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, false, "makulatlan" }
                });

            migrationBuilder.InsertData(
                table: "Jobs",
                columns: new[] { "ID", "Days", "Description", "EndDate", "Location", "MinRequiredExperience", "OwnerUserID", "Payment", "Repeated", "StartDate", "Status", "Title", "Type" },
                values: new object[,]
                {
                    { 1, "[\"Mon\",\"Wed\",\"Fri\"]", "Milio, the adorable four-legged companion, is in search of a caring pet sitter to take him on weekly adventures. As Milio's dedicated walker, you'll embark on leisurely strolls through the neighborhood, providing him with the exercise and social interaction he craves. Your bond with Milio will grow stronger with each outing, as you ensure he stays happy and healthy. Join Milio on his weekly walks and be part of his wagging tail tales!", null, "Szeged", 0, 1, 10, true, new DateTime(2023, 10, 22, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2279), 1, "Looking for a weekly walk buddy for Milio!", 2 },
                    { 2, null, "Calling all cat lovers! Randy, the charming feline, is seeking a reliable house sitter to provide him with the utmost comfort and care while his humans are away. Your duties include feeding Randy, ensuring his litter box is pristine, and offering plenty of cuddles and playtime to keep him content. Randy's cozy home is your domain during this assignment, making it a purr-fect opportunity to enjoy quality time with a delightful kitty. If you're ready to be Randy's temporary guardian, apply now for this fulfilling house-sitting role!", new DateTime(2023, 10, 24, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2343), "Szolnok", 1, 2, 20, false, new DateTime(2023, 10, 24, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2341), 1, "House-Sitting Delight: Randy the Cat's Comfy Companion Wanted!", 0 },
                    { 3, "[\"Tue\",\"Wed\",\"Fri\"]", "Are you a dog lover looking for a rewarding side gig? We have an exciting job for you! Join our team to take Luna and Rusty, a delightful pair of dogs (Luna, a charming female, and Rusty, an energetic male), on weekly walks. Enjoy the great outdoors while earning extra income and providing these furry friends with the exercise and companionship they adore. Join us in fostering healthy and happy dogs while making a furry duo's week brighter!", null, "Jászkarajenő", 3, 3, 30, true, new DateTime(2023, 10, 24, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2350), 1, "Weekly Dog Walking Opportunity for Luna and Rusty", 2 },
                    { 4, "[\"Mon\",\"Wed\",\"Fri\"]", "Join the adventure with Luna, the energetic pup! Luna is looking for an enthusiastic pet sitter to accompany her on daily escapades filled with fun and excitement. Your role includes playtime, exercise, and ensuring Luna's safety during your outings. Embrace the joy of being Luna's daily companion and make her tail wag with happiness!", null, "Debrecen", 0, 1, 15, true, new DateTime(2023, 10, 23, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2356), 1, "Daily Adventures with Luna!", 2 },
                    { 5, null, "Meet Whiskers, the charming senior cat in need of some extra TLC. Whiskers' owner is seeking a caring house sitter who can provide love, companionship, and attention to their beloved feline. Your daily routine includes feeding, gentle playtime, and ensuring Whiskers is comfortable and content. If you have a soft spot for senior cats and are ready to offer Whiskers a cozy haven, apply now!", new DateTime(2023, 10, 28, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2363), "Budapest", 2, 2, 25, false, new DateTime(2023, 10, 25, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2361), 1, "Senior Cat Care: Whiskers' Comfort Companion", 0 },
                    { 6, null, "Calling all canine enthusiasts! Max and Bella, the lively Labrador duo, are seeking an experienced pet sitter to provide them with weekly visits filled with fun and care. As their dedicated caretaker, you'll enjoy their playful antics and cherish the moments spent together. Your responsibilities include feeding, exercise, and ensuring Max and Bella have a fantastic weekly routine. Join Max and Bella on this pawsome journey and create unforgettable memories!", null, "Pécs", 4, 3, 20, false, new DateTime(2023, 10, 24, 15, 14, 6, 903, DateTimeKind.Local).AddTicks(2367), 1, "Weekly Labrador Love: Max and Bella's Pawsome Playdates", 3 }
                });
